	...
	template<typename T, typename AttackKind, typename ReleaseKind>
		class GainComputerCompressor : public GainComputer<T, AttackKind, ReleaseKind> {
			...
			public:
				...
				auto operator=(GainComputerCompressor<T, AttackKind, ReleaseKind>&& computer)
					noexcept -> GainComputerCompressor<T, AttackKind, ReleaseKind>& = default;
	...
	template<typename AttackKind, typename ReleaseKind>
		...
		public GainComputer<float, AttackKind, ReleaseKind>
		{
			...
			public:
				...
				auto operator=(GainComputerCompressor<float, AttackKind, ReleaseKind>&& computer)
					noexcept -> GainComputerCompressor<float, AttackKind, ReleaseKind>& = default;
	...
	template<typename AttackKind, typename ReleaseKind>
		...
		public GainComputer<double, AttackKind, ReleaseKind>
		{
			...
			public:
				...
				auto operator=(GainComputerCompressor<double, AttackKind, ReleaseKind>&& computer)
					noexcept -> GainComputerCompressor<double, AttackKind, ReleaseKind>& = default;
