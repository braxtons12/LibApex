	...
	template<>
		class SidechainModernBus<float> : Sidechain<float> {
			...
			public:
				...
				auto operator=(SidechainModernBus<float>&& sidechain) noexcept -> SidechainModernBus<float>& = default;

			private:
				LevelDetectorModernBus<float> mLevelDetector =
					LevelDetectorModernBus<float>(&mState);
	...
	template<>
		class SidechainModernBus<double> : Sidechain<double> {
			...
			public:
				...
				auto operator=(SidechainModernBus<double>&& sidechain) noexcept -> SidechainModernBus<double>& = default;

			private:
				LevelDetectorModernBus<double> mLevelDetector =
					LevelDetectorModernBus<double>(&mState);
