	...
	template<>
		class Sidechain<float> {
			...
			public:
				...
				[[nodiscard]]
					virtual auto getAttackTime() const noexcept -> float;
				...
				[[nodiscard]]
					virtual auto getReleaseTime() const noexcept -> float;
				...
				/// @return - The ratio
				[[nodiscard]]
					virtual auto getRatio() const noexcept -> float;
				...
				[[nodiscard]]
					virtual auto getThreshold() const noexcept -> float;
				...
				[[nodiscard]]
					virtual auto getKneeWidth() const noexcept -> float;
				...
				[[nodiscard]]
					virtual auto getDynamicsType() const noexcept -> DynamicsType;
				...
				[[nodiscard]]
					virtual auto getSampleRate() const noexcept -> size_t;
				...
				[[nodiscard]]
					virtual auto getCurrentGainReduction() const noexcept -> float;
				...
				[[nodiscard]]
					auto getLevelDetectorType() const noexcept -> LevelDetector<float>::DetectorType;
				...
				[[nodiscard]]
					auto getComputerTopology() const noexcept -> ComputerTopology;
	...
	template<>
		class Sidechain<double> {
			...
			public:
				...
				/// @return - The attack time, in milliseconds
				[[nodiscard]]
					virtual auto getAttackTime() const noexcept -> double;
				...
				/// @return - The release time, in milliseconds
				[[nodiscard]]
					virtual auto getReleaseTime() const noexcept -> double;
				...
				/// @return - The ratio
				[[nodiscard]]
					virtual auto getRatio() const noexcept -> double;
				...
				/// @return - The threshold, in decibels
				[[nodiscard]]
					virtual auto getThreshold() const noexcept -> double;
				...
				/// @return - The knee width, in decibels
				[[nodiscard]]
					virtual auto getKneeWidth() const noexcept -> double;
				...
				/// @return - The most recently calculated gain reduction value (linear)
				[[nodiscard]]
					virtual auto getCurrentGainReduction() const noexcept -> double;
				...
				/// @return - The type of the `LevelDetector`
				[[nodiscard]]
					auto getLevelDetectorType() const noexcept -> LevelDetector<double>::DetectorType;
