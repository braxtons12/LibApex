	...
	template<>
		class Sidechain1176<float> : Sidechain<float> {
			...
			public:
				...
				[[nodiscard]]
					auto getAttackTime() const noexcept -> float override;
				...
				[[nodiscard]]
					auto getReleaseTime() const noexcept -> float override;
				...
				auto operator=(Sidechain1176<float>&& sidechain) noexcept -> Sidechain1176<float>& = default;
			...
			private:
				...
				[[deprecated("Don't use, ratio is fixed for this `Sidechain`")]]
					auto setRatio(float ratio) noexcept -> void override {
				...
				[[deprecated("Don't use, threshold is fixed for this `Sidechain`")]]
					auto setThreshold(float threshold) noexcept -> void override {
				...
				[[deprecated("Don't use, knee width is fixed for this `Sidechain`")]]
					auto setKneeWidth(float kneeWidth) noexcept -> void override {
				...
				[[deprecated("Don't use, computer topology is fixed for this `Sidechain`")]]
					auto setComputerTopology(ComputerTopology topology) noexcept -> void override {
				...
				[[deprecated("Don't use, detector topology is fixed for this `Sidechain`")]]
					auto setDetectorTopology(DetectorTopology topology) noexcept -> void override {
						juce::ignoreUnused(topology);
					}
	...
	template<>
		class Sidechain1176<double> : Sidechain<double> {
			...
			public:
				...
				/// @return - The attack time in milliseconds
				[[nodiscard]]
					auto getAttackTime() const noexcept -> double override;
				...
				/// @return - The release time in milliseconds
				[[nodiscard]]
					auto getReleaseTime() const noexcept -> double override;
				...
				auto operator=(Sidechain1176<double>&& sidechain) noexcept -> Sidechain1176<double>& = default;
			...
			private:
				...
				/// @deprecated DO NOT USE, ratio is fixed for this `Sidechain`
				[[deprecated("Don't use, ratio is fixed for this `Sidechain`")]]
					auto setRatio(double ratio) noexcept -> void override {
						juce::ignoreUnused(ratio);
					}

				/// @deprecated DO NOT USE, threshold is fixed for this `Sidechain`
				[[deprecated("Don't use, threshold is fixed for this `Sidechain`")]]
					auto setThreshold(double threshold) noexcept -> void override {
						juce::ignoreUnused(threshold);
					}

				/// @deprecated DO NOT USE, knee width is fixed for this `Sidechain`
				[[deprecated("Don't use, knee width is fixed for this `Sidechain`")]]
					auto setKneeWidth(double kneeWidth) noexcept -> void override {
						juce::ignoreUnused(kneeWidth);
					}
