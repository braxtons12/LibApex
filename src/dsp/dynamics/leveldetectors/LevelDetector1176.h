	...
	template<>
		class LevelDetector1176<float> : public LevelDetector<float> {
			...
			public:
				...
				auto operator=(LevelDetector1176<float>&& detector)
					noexcept -> LevelDetector1176<float>& = default;
	...
	template<>
		class LevelDetector1176<double> : public LevelDetector<double> {
			...
			public:
				...
				auto operator=(LevelDetector1176<double>&& detector)
					noexcept -> LevelDetector1176<double>& = default;
