...
namespace apex::dsp {
	...
	class LevelDetectorModernBus<float> : public LevelDetector<float> {
	  ...
	  public:
		...
		auto operator=(LevelDetectorModernBus<float>&& detector) noexcept
			-> LevelDetectorModernBus<float>& = default;
	...
	class LevelDetectorModernBus<double> : public LevelDetector<double> {
	  ...
	  public:
		...
		auto operator=(LevelDetectorModernBus<double>&& detector) noexcept
			-> LevelDetectorModernBus<double>& = default;
