	...
	template<>
		class BiQuadFilter<float> {
			public:
				...
				///
				/// @return - A lowpass BiQuad Filter
				static auto MakeLowpass(float frequency, size_t sampleRate = 44100)
				...
				///
				/// @return - A lowpass BiQuad Filter
				static auto MakeLowpass(float frequency, float q = 0.7F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A highpass BiQuad Filter
				static auto MakeHighpass(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A highpass BiQuad Filter
				static auto MakeHighpass(float frequency, float q = 0.7F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A bandpass BiQuad Filter
				static auto MakeBandpass(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A bandpass BiQuad Filter
				static auto MakeBandpass(float frequency, float q = 0.7F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - An allpass BiQuad Filter
				static auto MakeAllpass(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - An allpass BiQuad Filter
				static auto MakeAllpass(float frequency, float q = 0.7F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A notch BiQuad Filter
				static auto MakeNotch(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A notch BiQuad Filter
				static auto MakeNotch(float frequency, float q = 0.7F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A lowshelf BiQuad Filter
				static auto MakeLowShelf(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A lowshelf BiQuad Filter
				static auto MakeLowShelf(
						float frequency, float gain = 0.0F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				/// @return - A lowshelf BiQuad Filter
				static auto MakeLowShelf(
						float frequency, float q = 0.7F, float gain = 0.0F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A highshelf BiQuad Filter
				static auto MakeHighShelf(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A bell-shape BiQuad Filter
				static auto MakeBell(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - A bell-shape BiQuad Filter
				static auto MakeBell(float frequency, float gain = 0.0F, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				///
				/// @return - An analog-style bell-shape BiQuad Filter
				static auto MakeAnalogBell(float frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<float>;
				...
				[[nodiscard]]
					auto getGainDB() const noexcept -> float;
				...
				[[nodiscard]]
					auto getMagnitudeForFrequency(float frequency) const noexcept -> float;
				...
				[[nodiscard]]
					auto getPhaseForFrequency(float frequency) const noexcept -> float;
	...
	template<>
		class BiQuadFilter<double> {
			public:
				...
				///
				/// @return - A lowpass BiQuad Filter
				static auto MakeLowpass(double frequency, size_t sampleRate = 44100)
				...
				///
				/// @return - A lowpass BiQuad Filter
				static auto MakeLowpass(double frequency, double q = 0.7, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A highpass BiQuad Filter
				static auto MakeHighpass(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A highpass BiQuad Filter
				static auto MakeHighpass(
						double frequency, double q = 0.7, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A bandpass BiQuad Filter
				static auto MakeBandpass(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - An allpass BiQuad Filter
				static auto MakeAllpass(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - An allpass BiQuad Filter
				static auto MakeAllpass(double frequency, double q = 0.7, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A notch BiQuad Filter
				static auto MakeNotch(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A notch BiQuad Filter
				static auto MakeNotch(double frequency, double q = 0.7, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A lowshelf BiQuad Filter
				static auto MakeLowShelf(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				/// @return - A lowshelf BiQuad Filter
				static auto MakeLowShelf(
						double frequency, double gain = 0.0, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A highshelf BiQuad Filter
				static auto MakeHighShelf(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A bell-shape BiQuad Filter
				static auto MakeBell(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - A bell-shape BiQuad Filter
				static auto MakeBell(double frequency, double gain = 0.0, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				///
				/// @return - An analog-style bell-shape BiQuad Filter
				static auto MakeAnalogBell(double frequency, size_t sampleRate = 44100)
					noexcept -> BiQuadFilter<double>;
				...
				/// @return - The gain, in Decibels
				[[nodiscard]]
					auto getGainDB() const noexcept -> double;
				...
				/// @return - The magnitude response at the given frequency
				[[nodiscard]]
					auto getMagnitudeForFrequency(double frequency) const noexcept -> double;
				...
				/// @return - The phase response at the given frequency
				[[nodiscard]]
					auto getPhaseForFrequency(double frequency) const noexcept -> double;
				...
				auto operator=(BiQuadFilter<double>&& filt)
					noexcept -> BiQuadFilter<double>& = default;
