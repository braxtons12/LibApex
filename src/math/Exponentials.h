...
namespace apex::math {
	...
	/// @return - The mantissa
	inline constexpr auto frexpf(float x, int* e) noexcept -> float {
	...
	/// @param x 
	/// @return
	inline constexpr auto exp_helperf(float x) noexcept -> float {
	...
	/// @return - e^x
	inline constexpr auto expf(float x) noexcept -> float {
		if(x < 2.5F) {
	...
	/// @param x - The input
	/// @return - log_2(x)
	inline constexpr auto log2f(float x) noexcept -> float {
		float y = 0.0F;
		float f = 0.0F;
		int e = 0;
		f = frexpf(fabsf(x), &e);
	...
	/// @param x - The input
	/// @return - log_10(x)
	inline constexpr auto log10f(float x) noexcept -> float {
	...
	/// @param x - The input
	/// @return - ln(x)
	inline constexpr auto logf(float x) noexcept -> float {
	...
	/// @param x - The exponent
	/// @return 2^x
	inline constexpr auto pow2f(float x) noexcept -> float {
	...
	/// @param x - The exponent
	/// @return 10^x
	inline constexpr auto pow10f(float x) noexcept -> float {
	...
	inline constexpr auto powf(float base, float exponent) noexcept -> float {
	...
	/// @param e - The `int` to store the exponent in
	/// @return - The mantissa
	inline constexpr auto frexp(double x, int *e) noexcept -> double {
	...
	/// @param x 
	/// @return
	inline constexpr auto exp_helper(double x) noexcept -> double {
	...
	/// @param x - The exponent
	/// @return - e^x
	inline constexpr auto exp(double x) noexcept -> double {
		if(x < 2.5) {
	...
	/// @param x - The input
	/// @return - log_2(x)
	inline constexpr auto log2(double x) noexcept -> double {
		double y = 0.0;
		double f = 0.0;
		int e = 0;
		f = frexp(fabs(x), &e);
	...
	/// @param x - The input
	/// @return - log_10(x)
	inline constexpr auto log10(double x) noexcept -> double {
	...
	/// @param x - The input
	/// @return - ln(x)
	inline constexpr auto log(double x) noexcept -> double {
	...
	/// @param x - The exponent
	/// @return 2^x
	inline constexpr auto pow2(double x) noexcept -> double {
	...
	/// @param x - The exponent
	/// @return 10^x
	inline constexpr auto pow10(double x) noexcept -> double {
	...
	/// @param exponent - The exponent to use
	/// @return - base^exponent
	inline constexpr auto pow(double base, double exponent) noexcept -> double {
