...
namespace apex::math {
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto cos_helperf(float x) noexcept -> float {
	...
	[[nodiscard]] constexpr inline auto cosf(float angle) noexcept -> float {
	...
	[[nodiscard]] constexpr inline auto sinf(float angle) noexcept -> float {
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto tan_helperf(float x) noexcept -> float {
	...
	[[nodiscard]] constexpr inline auto tanf(float angle) noexcept -> float {
		angle = fmodf(angle, twoPif);		   // Get rid of values >2 *pi
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto atan_helperf(float x) noexcept -> float {
	...
	[[nodiscard]] constexpr inline auto atanf(float angle) noexcept -> float {
	...
	[[nodiscard]] constexpr inline auto tanhf(float angle) noexcept -> float {
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto cos_helper(double x) noexcept -> double {
	...
	/// @param angle - The angle to calculate the cosine of
	/// @return - The cosine of the angle
	[[nodiscard]] constexpr inline auto cos(double angle) noexcept -> double {
	...
	/// @param angle - The angle to calculate the sine of
	/// @return - The sine of the angle
	[[nodiscard]] constexpr inline auto sin(double angle) noexcept -> double {
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto tan_helper(double x) noexcept -> double {
	...
	/// @param angle - The angle to calculate the tangent of
	/// @return - The tangent of the angle
	[[nodiscard]] constexpr inline auto tan(double angle) noexcept -> double {
		angle = fmod(angle, twoPi);			  // Get rid of values >2 *pi
	...
	/// @param x
	/// @return
	[[nodiscard]] constexpr inline auto atan_helper(double x) noexcept -> double {
	...
	/// @param angle - The angle to calculate the arctangent of
	/// @return - The arctangent of the angle
	[[nodiscard]] constexpr inline auto atan(double angle) noexcept -> double {
		bool complement = false; // true if arg was >1
		bool region = false;	 // true depending on region arg is in
		bool sign = false;		 // true if arg was < 0
	...
	/// @param angle - The angle to calculate the hyperbolic tanget of
	/// @return - The hyperbolic tangent of the angle
	[[nodiscard]] constexpr inline auto tanh(double angle) noexcept -> double {
